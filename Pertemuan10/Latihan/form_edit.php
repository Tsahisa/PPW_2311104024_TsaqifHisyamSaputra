...
<body>
    ...
    <form method="POST" action="proses_edit.php">
        <div class="form-group">
            <label>NIM:</label>
            <input type="text" name="nim" value="<?php echo $data['nim']; ?>" readonly style="background-color: #f0f0f0;">
        </div>
        <div class="form-group">
            <label>Nama:</label>
        ...
        <div class="form-group">
            <label>Email:</label>
            <input type="email" name="email" value="<?php echo $data['email']; ?>" maxlength="50">
        </div>
        <div class="form-group">
